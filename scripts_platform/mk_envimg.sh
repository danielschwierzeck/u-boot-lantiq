...
# !<WW:28-Nov-2019: tools/envcrc depend on ENV_IS_EMBEDDED
#  else it just return 0 , ok i just use standard linux crc32 command then
#  but seem wrong crc, maybe need to crc the whole ENV_SIZE (16KB)
#  anyway for now i turn off the crc check when himport
CRC=`crc32 env.tmp`
