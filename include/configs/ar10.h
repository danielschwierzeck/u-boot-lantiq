...
#elif defined(CONFIG_LTQ_BOOT_FROM_SPI)
#define IFX_CFG_FLASH_DDR_CFG_START_ADDR      0x0001FFE0
#define IFX_CFG_FLASH_DDR_CFG_SIZE            32
...
#ifdef CONFIG_LTQ_BOOT_FROM_NAND
#define CONFIG_SPL_TEXT_BASE CONFIG_NAND_SPL_TEXT_BASE
#elif defined(CONFIG_LTQ_BOOT_FROM_SPI)
#define CONFIG_SPL_TEXT_BASE 0xBE1A0000
#else
#define CONFIG_SPL_TEXT_BASE CONFIG_NOR_SPL_TEXT_BASE
#endif
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_FIRMWARE_IMAGE_BLOCK_NAME        "firmware"
  #define IFX_CFG_FLASH_FIRMWARE_IMAGE_START_ADDR        0x00030000
  #define IFX_CFG_FLASH_FIRMWARE_IMAGE_SIZE              0
  #define IFX_CFG_FLASH_FIRMWARE_IMAGE_MTDBLOCK_NAME     "/dev/mtdblock1"
  ...
  #define IFX_CFG_FLASH_KERNEL_IMAGE_BLOCK_NAME          "kernel"
  #define IFX_CFG_FLASH_KERNEL_IMAGE_START_ADDR          0x003E5FFF
  #define IFX_CFG_FLASH_KERNEL_IMAGE_SIZE                0

  #define IFX_CFG_FLASH_SYSTEM_CFG_BLOCK_NAME            "sysconfig"
  #define IFX_CFG_FLASH_SYSTEM_CFG_START_ADDR            0x003E6000
  #define IFX_CFG_FLASH_SYSTEM_CFG_SIZE                  0x8000
  #define IFX_CFG_FLASH_SYSTEM_CFG_END_ADDR              0x003EEFFF


  #define IFX_CFG_FLASH_UBOOT_CFG_BLOCK_NAME             "ubootconfig"
  #define IFX_CFG_FLASH_UBOOT_CFG_START_ADDR             0x003EF000
  #define IFX_CFG_FLASH_UBOOT_CFG_SIZE                   0x8000
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR               0x003F6FFF

  #define IFX_CFG_FLASH_DECT_CFG_BLOCK_NAME         	"dectconfig"
  #define IFX_CFG_FLASH_DECT_CFG_START_ADDR         	0x003F700
  #define IFX_CFG_FLASH_DECT_CFG_SIZE               	0x8000
  #define IFX_CFG_FLASH_DECT_CFG_END_ADDR           	0x003FFFFF
...
#define IFX_CFG_FLASH_PARTITIONS_INFO                                   \
        "part0_begin=0x00000000\0"                                      \
        "part1_begin=0x00020000\0"                                      \
        "part2_begin=0x00030000\0"                                      \
        "part3_begin=0x00064000\0"                                      \
        "total_part=4\0"
#else
#define IFX_CFG_FLASH_PARTITIONS_INFO                                   \
        "part0_begin=0x00000000\0"                                      \
        "part1_begin=0x00030000\0"                                      \
        "part2_begin=0x00064000\0"                                      \
        "total_part=3\0"
#endif
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_GPHY_FIRMWARE_IMAGE_START_ADDR    0x00030000
  ...
  #define IFX_CFG_FLASH_KERNEL_IMAGE_BLOCK_NAME           "kernel"
  #define IFX_CFG_FLASH_KERNEL_IMAGE_START_ADDR           0x00470000
  #define IFX_CFG_FLASH_KERNEL_IMAGE_SIZE                 0

  #define IFX_CFG_FLASH_SYSTEM_CFG_BLOCK_NAME             "sysconfig"
  #define IFX_CFG_FLASH_SYSTEM_CFG_START_ADDR             0x007B0000
  #define IFX_CFG_FLASH_SYSTEM_CFG_SIZE                   0x10000
  #define IFX_CFG_FLASH_SYSTEM_CFG_END_ADDR               0x007BFFFF

  #define IFX_CFG_FLASH_UBOOT_CFG_BLOCK_NAME              "ubootconfig"
  #define IFX_CFG_FLASH_UBOOT_CFG_START_ADDR              0x007C0000
  #define IFX_CFG_FLASH_UBOOT_CFG_SIZE                    0x10000
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR                0x007CFFFF

  #define IFX_CFG_FLASH_DECT_CFG_BLOCK_NAME               "dectconfig"
  #define IFX_CFG_FLASH_DECT_CFG_START_ADDR               0x007D0000
  #define IFX_CFG_FLASH_DECT_CFG_SIZE                     0x10000
  #define IFX_CFG_FLASH_DECT_CFG_END_ADDR                 0x007DFFFF

  #define IFX_CFG_FLASH_WLAN_CFG_BLOCK_NAME	          	"wlanconfig"
  #define IFX_CFG_FLASH_WLAN_CFG_START_ADDR	      	  	0x007E0000
  #define IFX_CFG_FLASH_WLAN_CFG_SIZE		          	0x10000
  #define IFX_CFG_FLASH_WLAN_CFG_END_ADDR		  		0x007EFFFF  
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_KERNEL_IMAGE_BLOCK_NAME           "kernel"
  #define IFX_CFG_FLASH_KERNEL_IMAGE_START_ADDR           0x00850000
  #define IFX_CFG_FLASH_KERNEL_IMAGE_SIZE                 0

  #define IFX_CFG_FLASH_SYSTEM_CFG_BLOCK_NAME             "sysconfig"
  #define IFX_CFG_FLASH_SYSTEM_CFG_START_ADDR             0x00E00000
  #define IFX_CFG_FLASH_SYSTEM_CFG_SIZE                   0x10000
  #define IFX_CFG_FLASH_SYSTEM_CFG_END_ADDR               0x00E0FFFF

  #define IFX_CFG_FLASH_UBOOT_CFG_BLOCK_NAME              "ubootconfig"
  #define IFX_CFG_FLASH_UBOOT_CFG_START_ADDR              0x00E10000
  #define IFX_CFG_FLASH_UBOOT_CFG_SIZE                    0x10000
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR                0x00E1FFFF

  #define IFX_CFG_FLASH_DECT_CFG_BLOCK_NAME               "dectconfig"
  #define IFX_CFG_FLASH_DECT_CFG_START_ADDR               0x00E20000
  #define IFX_CFG_FLASH_DECT_CFG_SIZE                     0x10000
  #define IFX_CFG_FLASH_DECT_CFG_END_ADDR                 0x00E2FFFF

  #define IFX_CFG_FLASH_WLAN_CFG_BLOCK_NAME	          	"wlanconfig"
  #define IFX_CFG_FLASH_WLAN_CFG_START_ADDR	      	  	0x00E30000
  #define IFX_CFG_FLASH_WLAN_CFG_SIZE		         	0x10000
  #define IFX_CFG_FLASH_WLAN_CFG_END_ADDR		  		0x00E3FFFF
...
#endif /*CONFIG_LTQ_BOOT_FROM_SPI*/
