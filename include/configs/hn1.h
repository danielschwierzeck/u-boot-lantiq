...
#define __CONFIG_H
 ...
 /* Modified by Andrei Toma for HN1, based on vr9.h header file */
...
#define RAM_CLOCK_RATE          100000000   /* 100 MHz clock for RAM           */
#elif CONFIG_HN1_CPU_200M_RAM_200M
#define CPU_CLOCK_RATE          200000000   /* 200 MHz clock for the MIPS core */
#define RAM_CLOCK_RATE          200000000   /* 200 MHz clock for RAM           */
#elif CONFIG_HN1_CPU_400M_RAM_200M
...
#define CONFIG_PREBOOT	"echo;"	\
	"echo Type \\\"run flash_flash\\\" to mount root filesystem over flash;" \
	"echo"
#endif
...
#define	CONFIG_SYS_PROMPT		"HN1 # "	/* Monitor Command Prompt    */
...
// AT: this was needed in UGW 4.3.1. In UGW 5.1 is defined always as 0x1000 (see above)
//#ifdef CONFIG_ENV_IS_IN_SPI_FLASH
//#define CFG_ENV_IS_IN_SPI_FLASH
////AT: for MXIC use 4KB and for SPANSION use 256KB sectors
//#ifdef CONFIG_SPI_FLASH_MXIC
//    #define CONFIG_ENV_SECT_SIZE 0x1000	//for 4kB sectors
//#else
//    #ifdef CONFIG_SPI_FLASH_SPANSION
//        //#define CONFIG_ENV_SECT_SIZE 0x10000	//for 64kB sectors
//        #define CONFIG_ENV_SECT_SIZE 0x40000	//for 256kB sectors
//    #else
//        Unsupported flash type for read/erase/write operations!
//        Chose MXIC or Spansion.
//    #endif
//#endif
...
// ToDo: use these definitions after '0x4000-24' is not a number bug is fixed.
//#define IFX_CFG_FLASH_DDR_CFG_START_ADDR      CONFIG_NAND_SPL_BLOCK_SIZE-24 
//#define IFX_CFG_FLASH_DDR_CFG_END_ADDR        CONFIG_NAND_SPL_BLOCK_SIZE-1
...
#define CONFIG_TUNING_STATUS 0xBF28FF20 
#define CONFIG_TUNING_SP     0xBF28FF00 
