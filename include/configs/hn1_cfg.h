...
/*
 * This file contains the configuration parameters for the HN1 board.
 */

 /* Modified by Andrei Toma for HN1 based on vr9_cfg.h header file */
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
 ...
 #define IFX_CFG_FLASH_KERNEL_IMAGE_BLOCK_NAME           "kernel"
  ...
  #define IFX_CFG_FLASH_SYSTEM_CFG_SIZE                   0x10000         //AT: was 0x8000 in UGW 4.3.1
  ...
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_SIZE                0x1000         //AT: was 0x200 in UGW 4.3.1
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_END_ADDR            0x003F1FFF
  
  #define IFX_CFG_FLASH_CALIBRATION_CFG_BLOCK_NAME	      "calibration"  //AT: was absent in UGW 4.3.1
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_KERNEL_IMAGE_BLOCK_NAME           "kernel"
  #define IFX_CFG_FLASH_KERNEL_IMAGE_START_ADDR           0x007DFFFF    //AT: OK for 4k sectors
  #define IFX_CFG_FLASH_KERNEL_IMAGE_SIZE                 0

  #define IFX_CFG_FLASH_SYSTEM_CFG_BLOCK_NAME             "sysconfig"
  #define IFX_CFG_FLASH_SYSTEM_CFG_START_ADDR             0x007E0000    //AT: OK for 4k sectors
  #define IFX_CFG_FLASH_SYSTEM_CFG_SIZE                   0x10000
  #define IFX_CFG_FLASH_SYSTEM_CFG_END_ADDR               0x007EFFFF    //AT: OK for 4k sectors

  #define IFX_CFG_FLASH_UBOOT_CFG_BLOCK_NAME              "ubootconfig"
  #define IFX_CFG_FLASH_UBOOT_CFG_START_ADDR              0x007F0000    //AT: OK for 4k sectors
  #define IFX_CFG_FLASH_UBOOT_CFG_SIZE                    0x1000
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR                0x007F0FFF    //AT: OK for 4k sectors

  #define IFX_CFG_FLASH_FIRMWARE_DIAG_BLOCK_NAME          "fwdiag"
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_START_ADDR          0x007F1000    //AT: OK for 4k sectors
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_SIZE                0x1000        //AT: was 0x400 in UGW 4.3.1
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_END_ADDR            0x007F1FFF    //AT: OK for 4k sectors
...
#elif (IFX_CONFIG_FLASH_SIZE == 16)		//AT: for 16MBytes chips with 256KByes sectors
#define IFX_CFG_FLASH_PARTITIONS_INFO                                   \
        "part0_begin=0x00000000\0"                                      \
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  //AT: ToDo add a 'calibration' partition
  
  #define IFX_CFG_FLASH_END_ADDR                         0x00FFFFFF
  #define IFX_CFG_FLASH_END_ADDR_P1                      0x01000000

  #define IFX_CFG_FLASH_FIRMWARE_DIAG_BLOCK_NAME         "fwdiag"
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_SIZE               0x00040000 //use a whole 256k sector
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_START_ADDR         0x00FC0000
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_END_ADDR           0x00FFFFFF

  #define IFX_CFG_FLASH_UBOOT_CFG_BLOCK_NAME             "ubootconfig"
  #define IFX_CFG_FLASH_UBOOT_CFG_SIZE                   0x00040000 //use a whole 256k sector
  #define IFX_CFG_FLASH_UBOOT_CFG_START_ADDR             0x00F80000
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR               0x00FBFFFF

  #define IFX_CFG_FLASH_SYSTEM_CFG_BLOCK_NAME            "sysconfig"
  #define IFX_CFG_FLASH_SYSTEM_CFG_SIZE                  0x00040000 //use a whole 256k sector
  #define IFX_CFG_FLASH_SYSTEM_CFG_START_ADDR            0x00F40000
  #define IFX_CFG_FLASH_SYSTEM_CFG_END_ADDR              0x00F7FFFF

  #define IFX_CFG_FLASH_KERNEL_IMAGE_BLOCK_NAME          "kernel"
  #define IFX_CFG_FLASH_KERNEL_IMAGE_START_ADDR          0x00F3FFFF
  #define IFX_CFG_FLASH_KERNEL_IMAGE_SIZE                0
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_UBOOT_IMAGE_BLOCK_NAME            "uboot"
  #define IFX_CFG_FLASH_UBOOT_IMAGE_START_ADDR            0x00000000
  #define IFX_CFG_FLASH_UBOOT_IMAGE_SIZE                  0x10000
  #define IFX_CFG_FLASH_UBOOT_IMAGE_MTDBLOCK_NAME         "/dev/mtdblock0"
  ...
  #define IFX_CFG_FLASH_GPHY_FIRMWARE_IMAGE_SIZE          0x10000
  #define IFX_CFG_FLASH_GPHY_FIRMWARE_IMAGE_END_ADDR      0x0001FFFF
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_ROOTFS_IMAGE_SIZE                 0x06D40000       //AT: exact size is needed for JFFS2
  #define IFX_CFG_FLASH_ROOTFS_IMAGE_MTDBLOCK_NAME        "/dev/mtdblock2"
...
#define IFX_CFG_FLASH_PARTITIONS_INFO                                   \
        ...
        "part1_begin=0x00040000\0"                                      \
        "part2_begin=0x002C0000\0"                                      \
        "part3_begin=0x1F000000\0"                                      \
        "part4_begin=0x1F040000\0"                                      \
        "part5_begin=0x1F080000\0"                                      \
        "total_part=6\0"
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_ROOTFS_IMAGE_BLOCK_NAME           "rootfs"
  #define IFX_CFG_FLASH_ROOTFS_IMAGE_START_ADDR           0x002C0000
  //#define IFX_CFG_FLASH_ROOTFS_IMAGE_SIZE                 0x06D40000       //AT: use same size as for 128MB configuration
  #define IFX_CFG_FLASH_ROOTFS_IMAGE_SIZE                 0x1ED40000		//AT: 505088KBytes  
  #define IFX_CFG_FLASH_ROOTFS_IMAGE_MTDBLOCK_NAME        "/dev/mtdblock2"

  #define IFX_CFG_FLASH_SYSTEM_CFG_BLOCK_NAME             "sysconfig"
  #define IFX_CFG_FLASH_SYSTEM_CFG_START_ADDR             0x1F000000
  #define IFX_CFG_FLASH_SYSTEM_CFG_SIZE                   0x40000
  #define IFX_CFG_FLASH_SYSTEM_CFG_END_ADDR               0x1F03FFFF
  #define IFX_CFG_FLASH_SYSTEM_CFG_MTDBLOCK_NAME          "/dev/mtdblock3"

  #define IFX_CFG_FLASH_UBOOT_CFG_BLOCK_NAME              "ubootconfig"
  #define IFX_CFG_FLASH_UBOOT_CFG_START_ADDR              0x1F040000
  #define IFX_CFG_FLASH_UBOOT_CFG_SIZE                    0x1000
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR                0x1F040FFF
  #define IFX_CFG_FLASH_UBOOT_CFG_MTDBLOCK_NAME           "/dev/mtdblock4"

  #define IFX_CFG_FLASH_FIRMWARE_DIAG_BLOCK_NAME          "fwdiag"
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_START_ADDR          0x1F080000
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_SIZE                0x40000
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_END_ADDR            0x1F0BFFFF
  #define IFX_CFG_FLASH_FIRMWARE_DIAG_MTDBLOCK_NAME       "/dev/mtdblock5"

  //AT: Leave space unused at the end, between 1F0C.0000 and the end
...
#define IFX_CFG_FLASH_PARTITIONS_INFO                                   \
        "part0_begin=0x00000000\0"                                      \
        "part1_begin=0x00024000\0"                                      \
        "part2_begin=0x00040000\0"                                      \
        "part3_begin=0x000C0000\0"                                      \
        "part4_begin=0x002C0000\0"                                      \
        "part5_begin=0x1F000000\0"                                      \
        "part6_begin=0x1F040000\0"                                      \
        "part7_begin=0x1F080000\0"                                      \
        "total_part=8\0"
...
#define IFX_CFG_FLASH_DATA_BLOCKS_INFO                                  \
  ...
  #define IFX_CFG_FLASH_GPHY_FIRMWARE_IMAGE_BLOCK_NAME    "gphy_firmware"
  #define IFX_CFG_FLASH_GPHY_FIRMWARE_IMAGE_START_ADDR    0x00024000
...
//  #define IFX_CFG_FLASH_ROOTFS_IMAGE_SIZE                 0x06D40000		//AT: use same size as for 128MB configuration
  ...
  #define IFX_CFG_FLASH_UBOOT_CFG_END_ADDR                0x1F04FFFF
