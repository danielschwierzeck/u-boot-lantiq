...
enum { DMA_CHAN_GLOBAL_POLLING_DIS = 0,
       DMA_CHAN_GLOBAL_POLLING_EN,
};

enum { DMA_PORT_TXWGT0 = 0,
       DMA_PORT_TXWGT1,
       DMA_PORT_TXWGT2,
       DMA_PORT_TXWGT3,
       DMA_PORT_TXWGT4,
...
#define DMA_CIE_ALL                                                            \
	(DMA_CIE_EOP | DMA_CIE_DUR | DMA_CIE_DESCPT | DMA_CIE_CHOFF |          \
	 DMA_CIE_RDERR)

#define DMA_CIE_DEFAULT (DMA_CIE_EOP | DMA_CIE_DESCPT)

/* Because of the X-BAR settings in PRX300
 * is changed to LE, the NGI_ENDIAN_IA has to config
 * to LE. Hence, DMA1TX/RX descriptor has to be
 * configured in LE mode.
*/
