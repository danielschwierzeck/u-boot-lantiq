...
#define ASC_BASE 0xb6600000

/***********************************************************************/
/*  Module      :  CGU register address and bits                       */
/***********************************************************************/
#define CGU_BASE 0xb6200000
...
#define CGU_CLKGCR1_A_USB0_MASK      0x40
#define CGU_CLKGCR1_A_SPI0_MASK      0x100
#define CGU_CLKGCR1_A_USB1_MASK      0x08000000
...
{
	const unsigned int config = read_c0_prid();

	return (config >> 8) & 0xff;
}

static inline bool cpu_is_cps(void)
{
	return get_cpu_id() == 0xa1;
}

static inline void r4k_wait_irqoff(void)
{
