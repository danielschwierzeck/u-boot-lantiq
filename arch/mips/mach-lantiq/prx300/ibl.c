...
#define asc_puts lq_serial_puts
#define asc_putc lq_serial_putc

/* IRQ Numbers and handler definations */
#define  VMB_CPU_IPI1           200
#define  VMB_CPU_IPI2           201
#define  VMB_CPU_IPI3           202

/* FW/IBL -> VMB IPI numbers */
#define FW_VMB_IPI1             203
#define FW_VMB_IPI2             204
#define FW_VMB_IPI3             205

#ifdef CONFIG_LTQ_BOOT_FROM_NAND
#define CONFIG_TEXT_BASE_ADDR	CONFIG_NAND_SPL_TEXT_BASE
#elif CONFIG_LTQ_BOOT_FROM_SPI
#define CONFIG_TEXT_BASE_ADDR	CONFIG_SFDDR_TEXT_BASE
#elif CONFIG_LTQ_BOOT_FROM_QSPI
#define CONFIG_TEXT_BASE_ADDR	CONFIG_SFDDR_TEXT_BASE
#endif

extern void lq_serial_puts (const char *s);
...
void ibl(u32 cpu_num, u32 core_num, u32 vpe_num)
{
	...
	//asc_puts("\nPRX300 MX cpu "); print_u8(cpu_num);asc_puts("\n");
