...
static int nand_read_page(struct mtd_info *mtd, int block, int page, uchar *dst)
{
    ...
    this->ecc.read_page(mtd, this, dst, 0, page);
...
void nand_boot(void)
{
    ...
    nand_load(mtd_data, IFX_CFG_FLASH_DDR_CFG_END_ADDR+1-CONFIG_SYS_NAND_PAGE_SIZE, CONFIG_SYS_NAND_PAGE_SIZE, (u8*)0xa0100000);
    buffer[0] = 0;
    for(i=0;i<8;i++){
