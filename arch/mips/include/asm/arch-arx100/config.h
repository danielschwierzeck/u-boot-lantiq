 ...
 * PLL0 clock output is 500 MHz
 * PLL1 clock output is fractional for alternate clocks
 */
#define LTQ_CLK_CPU_393_DDR_197		0
#define LTQ_CLK_CPU_333_DDR_167		1
#define LTQ_CLK_CPU_167_DDR_167		2
#define LTQ_CLK_CPU_111_DDR_111		3
